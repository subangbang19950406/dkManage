...
export default class SystemList extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <FilteTable
                    questRenderReset={this.questRender}
...
class FilteTable extends React.Component {
                    ...
                    <Form.Item label="参数查询类型" style={{ marginLeft: 30 }}>
                        {getFieldDecorator('queryType', {
                            ...
                            >
                                ...
                                <Option value="1">类型编码查询</Option>
                                <Option value="2">名称模糊查询</Option>
                            </Select>
                        )}
                    </Form.Item>
                    <Form.Item label="参数编号(选填)：" style={{ marginLeft: 30 }}>
    ...
    handleReset(e) {
        ...
        this.props.searchPage(this.state.searchPage)
    ...
    render() {
        ...
        return (
            <div style={{ overflow: "hidden" }}>
                <Form layout="inline" >
                    <Form.Item label="参数编号" style={{ marginLeft: 30 }}>
                        {getFieldDecorator('paramCode')(
                    ...
                    <Form.Item label="类型编号：" style={{ marginLeft: 30 }}>
                        {getFieldDecorator('paramTypeCode')(
                            <Input style={{ width: 350 }} placeholder="请输入" />
                        )}
                    </Form.Item>
                    <Form.Item label="数值类型：" style={{ marginLeft: 30 }}>
    ...
    render() {
        return (
            <div>
                ...
                <p>值类型：{this.props.chakanRecord.valueType}</p>
