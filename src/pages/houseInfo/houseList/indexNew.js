...
class Detial extends React.Component {
    ...
    render() {
       console.log("不通过查看objsFlag",this.props.objsFlag)

        return (
            <div className="chakanD">
                <p>业主姓名：{this.props.objsFlag ? this.props.custArrDa : this.props.owerArra}<span style={{ marginLeft: 140 }}>业主手机号：{this.props.objsFlag ? this.props.custArrDb : this.props.owerArrb}</span></p>
                <p>业主身份证号：{this.props.objsFlag ? this.props.custArrDc : this.props.owerArrc}</p>
                <p className="imgP">
                    业主证明信息：
                        {this.props.objsFlag ? <Zmage src={"https://test.dongkenet.com/" + this.props.custArrDd} /> : <Zmage src={"https://test.dongkenet.com/" + this.props.owerArrd} />}
                    {this.props.objsFlag ? <Zmage src={"https://test.dongkenet.com/" + this.props.custArrDe} /> : <Zmage src={"https://test.dongkenet.com/" + this.props.owerArre} />}
                    {this.props.objsFlag ? this.props.custImgD : this.props.owerImgs}
                </p>
                <div>
                    {
                        this.props.objsFlag ? "" : <div>
                            <p>委托人姓名：{this.props.custArra}<span style={{ marginLeft: 140 }}>业主手机号：{this.props.custArrb}</span></p>
                            <p>业主身份证号：{this.props.custArrc}</p>
                            <p className="imgP">
                                委托人证明信息：
                                <Zmage src={"https://test.dongkenet.com/" + this.props.custArrd} />
                                <Zmage src={"https://test.dongkenet.com/" + this.props.custArre} />
                                {this.props.custImgs}
                            </p>
    ...
    render() {
        ...
        return (
            <div className="chakanV">
                <p>业主姓名：{this.props.flag ? this.props.custArrDa : this.props.owerArra}<span style={{ marginLeft: 140 }}>业主手机号：{this.props.flag ? this.props.custArrDb : this.props.owerArrb}</span></p>
                <p>业主身份证号：{this.props.flag ? this.props.custArrDc : this.props.owerArrc}</p>
                <p className="imgP">
                    业主证明信息：
                        <Zmage src={"https://test.dongkenet.com/" + (this.props.flag ? this.props.custArrDd : this.props.owerArrd)} />
                    <Zmage src={"https://test.dongkenet.com/" + (this.props.flag ? this.props.custArrDe : this.props.owerArre)} />
        ...
        return (
            <div style={{ overflow: "hidden" }} className="shenhe">
                <Form className="login-form">
                    <p>业主姓名：{this.props.shenheflag ? this.props.custArrDa : this.props.owerArra}<span style={{ marginLeft: 140 }}>业主手机号：{this.props.shenheflag ? this.props.custArrDb : this.props.owerArrb}</span></p>
                    <p>业主身份证号：{this.props.shenheflag ? this.props.custArrDc : this.props.owerArrc}</p>
                    <p className="imgP">
                        业主证明信息：
                        <Zmage src={"https://test.dongkenet.com/" + (this.props.shenheflag ? this.props.custArrDd : this.props.owerArrd)} />
                        <Zmage src={"https://test.dongkenet.com/" + (this.props.shenheflag ? this.props.custArrDe : this.props.owerArre)} />
                        {!this.props.shenheflag ? this.props.custImgD : this.props.owerImgs}
                    </p>
                    <div>
                        {
    ...
    showModals(record) {
        ...
        fetchPost("https://test.dongkenet.com/api/bms/1.0.0.daily/house-verify/query", {
            ...
            if (res.data.houseOwnerPo) {
                ...
                //姓名，手机号，身份证号，身份证正面，反面，房屋认真书两张
                info.certificatePics.map((ite, ins) => {
                    owerImgs.push(<Zmage src={"https:test.dongkenet.com/" + ite.housePicUrl} key={ins} />)
                })
                let custArr = {
                    a: info.custName,
                    b: info.phoneNbr,
                ...
                info.proxyPics.map((ites, inss) => {
                    custImgs.push(<Zmage src={"https:test.dongkenet.com/" + ites.housePicUrl} key={inss} />)
                })
                //姓名，手机号，身份证号，身份证正面，反面，委托书照片
                ...
                info.certificatePics.map((ite, ins) => {
                    custImgD.push(<Zmage src={ite.housePicUrl} key={ins} />)
                })
    ...
    showModalB(record) {
        ...
        fetchPost("https://test.dongkenet.com/api/bms/1.0.0.daily/house-verify/query", {
            ...
            if (res.data.houseOwnerPo) {
                ...
                info.certificatePics.map((ite, ins) => {
                    custImgV.push(<Zmage src={ite.housePicUrl} key={ins} />)
                })
                let objs = {
                    custArrV: custArrV,
                    custImgV: custImgV,
